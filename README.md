...
- **Chat request/response trace**: [`docs/chat-flow-diagram.md`](docs/chat-flow-diagram.md) — a mermaid sequence diagram tracing one message through the real code, step by step, both outcomes (answer / clarification).
